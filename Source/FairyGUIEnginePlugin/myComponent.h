...
//
//  18/01/2011
//  SAMPLEPLUGIN_IMPEXP prefix added + include to new FairyGUIEnginePluginModule.h
//

#ifndef MYCOMPONENT_H_INCLUDED
#define MYCOMPONENT_H_INCLUDED

#include "FairyGUIEnginePluginModule.h"
...
//  class will take care of this.  
  ...
  SAMPLEPLUGIN_IMPEXP void onAfterAttach( VisTypedEngineObject_cl *pOwner );

  SAMPLEPLUGIN_IMPEXP void onBeforeDetach(  VisTypedEngineObject_cl *pOwner );
