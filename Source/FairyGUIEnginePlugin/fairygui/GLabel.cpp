...
const VColorRef& GLabel::getTitleColor() const
{
...
void GLabel::setTitleColor(const VColorRef & value)
{
    if (dynamic_cast<GTextField*>(_titleObject))
...
float GLabel::getTitleFontSize() const
{
    if (dynamic_cast<GTextField*>(_titleObject))
...
void GLabel::setTitleFontSize(float value)
{
    if (dynamic_cast<GTextField*>(_titleObject))
