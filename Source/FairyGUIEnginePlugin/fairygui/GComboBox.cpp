...
void GComboBox::constructFromXML(TXMLElement * xml)
{
    ...
    if (p)
    {
        ...
        _list->addListener(UIEventType::ClickItem, CALLBACK_1(GComboBox::onClickItem, this));
        ...
        _dropdown->addListener(UIEventType::RemoveFromStage, CALLBACK_1(GComboBox::onPopupWinClosed, this));
    }

    addListener(UIEventType::RollOver, CALLBACK_1(GComboBox::onRollover, this));
    addListener(UIEventType::RollOut, CALLBACK_1(GComboBox::onRollout, this));
    addListener(UIEventType::TouchBegin, CALLBACK_1(GComboBox::onTouchBegin, this));
    addListener(UIEventType::TouchEnd, CALLBACK_1(GComboBox::onTouchEnd, this));
}
