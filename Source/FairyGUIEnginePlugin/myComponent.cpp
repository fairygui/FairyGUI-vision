...
void MyComponent::onAfterAttach( VisTypedEngineObject_cl *pOwner )
{
  //  do the component start up code here.......
  //  [...]

  Vision::Message.Add(1,"myComponent - onAfterAttach()");
  count = 0;
}

void MyComponent::onBeforeDetach(  VisTypedEngineObject_cl *pOwner )
{
  //  do the component Removal code here.......
  //  [...]
  Vision::Message.reset();
  Vision::Message.Add("myComponent - onBeforeDetach()");
}
...
void MyComponent::SetOwner( VisTypedEngineObject_cl *pOwner )
{
  if (pOwner==NULL)
  {
    onBeforeDetach( GetOwner() ); // Use current owner just before detach
    Vision::Message.Add("myComponent - Removing Component Instance from component Manager");
